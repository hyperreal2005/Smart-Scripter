...
# Set the path to the Smartscript folder on your desktop
desktop_path = os.path.join(os.path.expanduser("~"), "Desktop", "SmartScript")

# Create the nltk_data directory within the Smartscript folder
